/**
 * This was the first iteration of this exercise. It's very messy but essentially the same code as the current one. Just keeping it here for reference.
 */
...
export class RayCaster {
  ...
  loadMap() {
    const initialMap = [], camera = {x: 0, y: 0, t: Math.PI / 2};
    for (let i = 0; i < this.mapSizeY; i++) {
      let row = [];
      for (let j = 0; j < this.mapSizeX; j++) {
